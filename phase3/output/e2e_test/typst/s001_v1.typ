...
// Question 1
#block()[
  *1.* What is the name of the sorting algorithm that repeatedly divides the array in half? _(1 point)_
...
// Question 4
#block()[
  *4.* Which of the following is NOT a valid HTTP method? _(1 point)_
...
// Question 5
#block()[
  *5.* In object-oriented programming, what is encapsulation? _(1 point)_
...
// Question 6
#block()[
  *6.* Which data structure uses LIFO (Last In First Out) principle? _(1 point)_
...
// Question 7
#block()[
  *7.* What is the time complexity of binary search in a sorted array? _(1 point)_
...
// Question 8
#block()[
  *8.* What does the acronym 'RAM' stand for? _(1 point)_
