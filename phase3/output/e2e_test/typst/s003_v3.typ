...
// Question 5
#block()[
  *5.* What does the acronym 'RAM' stand for? _(1 point)_
...
// Question 6
#block()[
  *6.* In object-oriented programming, what is encapsulation? _(1 point)_
...
// Question 8
#block()[
  *8.* What is the time complexity of binary search in a sorted array? _(1 point)_
